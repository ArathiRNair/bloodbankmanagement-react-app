                    ...
                    <div className="col col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div className="row g-3">
                            ...
                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                ...
                                <input name="email" value={input.email} onChange={inputHandler} type="email" className="form-control" />
                            </div>

                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                <label htmlFor="" className="form-label">city</label>
                                <input name="city" value={input.city} onChange={inputHandler} type="text" className="form-control" />
                            </div>

                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                <label htmlFor="" className="form-label">weight_kg</label>
                                <input name="weight_kg" value={input.weight_kg} type="number" onChange={inputHandler} className="form-control" />
                            </div>

                            <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                <label htmlFor="" className="form-label">last_donation_date</label>
                                <input 
                                name="last_donation_date" value={input.last_donation_date} onChange={inputHandler} type="date" className="form-control" />
                            </div>
